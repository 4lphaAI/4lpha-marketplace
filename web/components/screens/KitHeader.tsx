...
function KitHeader({ route, go, search, onSearchChange }: {
  ...
  const linkBase = { padding: "0 10px", height: 28, display: "flex", alignItems: "center", gap: 6, borderRadius: "var(--radius-sm)", font: "var(--weight-medium) var(--text-base)/1 var(--font-sans)", textDecoration: "none" };
  return (
