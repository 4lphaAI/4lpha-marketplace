...
**Evidence captured 8 September 2026.** These are selected real production tasks, not simulated marketplace-card statistics or a 30-day backtest. The five selected tasks cover the active mubarak Grid, the best-returning completed mubarak LP, the stronger of the two active USDT/WBNB LPs, the best-returning closed Trading position among 11 captured at 16:47:55 UTC, and a Lending agent with receipt-confirmed repayments. Different windows are shown explicitly; this is a curated showcase, not an aggregate return or a claim that every agent beats HODL.
